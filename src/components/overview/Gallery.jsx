...
export default function Gallery() {
  ...
  return (
    <div className="flex justify-center">
      <img className="w-full object-cover mx-4" src={current} />
      ...
      <button onClick={() => {handleLeft}}>
        <svg
          ...
          strokeWidth={3}
          stroke="currentColor"
          className="absolute top-1/2 left-56 transform -translate-y-1/2 w-6 h-6 bold"
        >
          <path
            strokeLinecap="round"
      ...
      <button onClick={() => {handleRight}}>
        <svg
          ...
          stroke-width="3"
          stroke="currentColor"
          className="absolute top-1/2 transform -translate-y-1/2 w-6 h-6 bold"
        >
          <path
